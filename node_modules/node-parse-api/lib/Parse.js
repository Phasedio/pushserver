...
Parse.prototype = {
    ...
    insertInstallationDataWithChannels: function (deviceType, deviceToken, channels, senderID, callback) {
        if (deviceType === 'ios'){
            data = { deviceType: deviceType, deviceToken: deviceToken, channels: channels };
        }
        else {
            data = { deviceType: deviceType, deviceToken: deviceToken, pushType : 'gcm', GCMSenderId :senderID,  channels: channels };
        }
        parseRequest.call(this, 'POST', '/1/installations/', data, callback);
    },
    ...
    addInstallationUser: function(objectId, userObj, callback) {
        parseRequest.call(this, 'PUT', '/1/installations/' + objectId, {
            user: userObj
        }, callback);
    },
